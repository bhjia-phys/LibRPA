...
struct IndependentHeadwingPaths
{
    std::filesystem::path directory;
    std::filesystem::path kpoints;
    std::filesystem::path eigenvalues;
    std::vector<std::filesystem::path> wavefunctions;
    std::filesystem::path velocity;
};
...
public:
    ...
    HartreeUpdateMode hartree_update() const noexcept
    {
        return hartree_update_;
    }
...
private:
    ...
    HartreeUpdateMode hartree_update_ = HartreeUpdateMode::Off;
