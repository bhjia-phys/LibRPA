...
void driver::task_qsgw()
{
    ...
    // --- QSGW knobs parsed from librpa.in into Params; env overrides below are
    //     retained only for ad-hoc diagnostics. ---
    std::string qsgw_mixer_mode = normalized_qsgw_mixer(librpa_int::Params::qsgw_mixer);
    double mixing_beta = librpa_int::Params::qsgw_mixing_beta;
    int mixing_history = librpa_int::Params::qsgw_mixing_history;
    int linear_mixing_steps = librpa_int::Params::qsgw_linear_mixing_steps;
    ...
    int qsgw_min_iterations = librpa_int::Params::qsgw_min_iter;
    {
    ...
    int qsgw_max_iterations = librpa_int::Params::qsgw_max_iter;
    ...
    bool qsgw_dump_iter1 = librpa_int::Params::qsgw_dump_iter1;
    std::string qsgw_dump_dir;
    {
        ...
        else if (!librpa_int::Params::qsgw_dump_dir.empty())
            qsgw_dump_dir = librpa_int::path_as_directory(librpa_int::Params::qsgw_dump_dir);
        else
