...
gate1_accept=/home/bhj/ai-runs/librpa-qsgw-gate1-current-postcheck-20260723-36d74369-v1
gate1_source=/home/bhj/ai-runs/librpa-qsgw-gate1-current-20260723-4f9ab0cf-g0w0-v2
...
expected_gate1_comparison_sha=218d80ac9595b86d1c4e087018f4302eca13b3b8a5c2aa906f9b55211378894e
...
grep -Fqx 'gate=fish_gate1_current_g0w0_ab_recovery_v2' \
...
cp "$0" "$run_root/run_fish_gate2_current_v2.sh"
...
run_succeeded=1
trap - EXIT
printf 'FISH_GATE2_CURRENT_QSGW_FIRST_SELF_ENERGY_V2=PASS\n'
