...
runner_relative=qsgw-rebase-evidence/remote/abacus-pinned-dd421665-20260720/assemble_fish_si_k444_symmetry_physical_bundle_v1.sh
...
gate=fish_pinned_abacus_si_k444_symmetry_physical_bundle_v1
...
echo FISH_SI_K444_SYMMETRY_PHYSICAL_BUNDLE_V1=PASS
