...
: "${RUNNER_SHA256:?RUNNER_SHA256 must identify the normalized stdin runner}"
bare_repo=/tmp/librpa-qsgw-cb294020-84e6b0a/repo.git
source_root=/tmp/librpa-qsgw-reader-binding-green-v2-b7273e13
build_root=$source_root/build
run_root=/home/bhj/ai-runs/librpa-qsgw-reader-binding-20260720-v2
...
mkdir -p "$run_root"
printf '%s\n' "$RUNNER_SHA256" >"$run_root/runner-normalized-sha256.txt"
...
printf '%s\n' \
  ...
  "runner_normalized_sha256=$RUNNER_SHA256" \
