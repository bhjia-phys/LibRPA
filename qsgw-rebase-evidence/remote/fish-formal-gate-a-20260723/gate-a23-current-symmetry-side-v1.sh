...
bundle=/home/bhj/ai-runs/abacus-pinned-dd421665-si-k444-symmetry-bundle-20260720-v4
...
expected_bundle_provenance_sha=88cbcde30bc927495a96d0b779bfb4854cabb014911c08907643ff661d06463a
expected_bundle_output_sha=d16cb9df89de56895e9533a9f2253ea8ec0b4f8ea6f7b027b659f5ff8dfb5c46
...
test -x "$python"
mkdir -p "$tool_dir"
cp "$0" "$run_root/gate-a23-current-symmetry-side-v1.sh"
test "$(sha256sum "$run_root/gate-a23-current-symmetry-side-v1.sh" | awk '{print $1}')" = \
  "$RUNNER_SHA256"
...
echo CURRENT_QSGW_SYMMETRY_SIDE_V1=PASS_PENDING_FULL_BZ_CONTROL
