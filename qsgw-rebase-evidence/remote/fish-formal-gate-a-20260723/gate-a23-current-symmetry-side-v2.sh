...
bundle=/home/bhj/ai-runs/abacus-pinned-dd421665-si-k444-symmetry-physical-bundle-20260723-v1
...
expected_bundle_provenance_sha=96ac96fdd196b2d6a53034724c4999ab31acaee3db621829ede836e3b7079eaf
expected_bundle_output_sha=b044ca10b8c5516c3b3bea1f001d6ec1b721042fc000ae7ad4e455a55ad82be8
...
runner_relative=qsgw-rebase-evidence/remote/fish-formal-gate-a-20260723/gate-a23-current-symmetry-side-v2.sh
...
test -x "$python"
mkdir -p "$tool_dir"
cp "$0" "$run_root/gate-a23-current-symmetry-side-v2.sh"
test "$(sha256sum "$run_root/gate-a23-current-symmetry-side-v2.sh" | awk '{print $1}')" = \
  "$RUNNER_SHA256"
...
echo CURRENT_QSGW_SYMMETRY_SIDE_V2=PASS_PENDING_FULL_BZ_CONTROL
