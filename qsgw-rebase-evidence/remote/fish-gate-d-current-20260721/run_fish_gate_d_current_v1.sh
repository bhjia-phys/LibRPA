...
run_root=/home/bhj/ai-runs/librpa-qsgw-gate-d-${RUN_TAG}
...
runner_source=$candidate_source/qsgw-rebase-evidence/remote/fish-gate-d-current-20260721/run_fish_gate_d_current_v1.sh
...
comparison=current_qsgw_band_cut_modes_0_1_2
acceptance_scope=structural_and_metamorphic_not_legacy_numerical_acceptance
changed_factor=qsgw_band0_cut_mode
fixed_qsgw_band0_unoccupied_keep=10
fixed_qsgw_band0_cut_shift_ha=20.0
fixed_qsgw_mixer=none
...
EOF
  ...
  for trace in qsgw_matrices.dat qsgw_eigenvalues.dat qsgw_iterations.dat; do
    ...
    grep -Fqx '# qsgw_mixer none' "$mode_root/$trace"
...
accepted=true
scope=current_qsgw_band_structural_and_metamorphic_gate
...
gate=fish_gate_d_current_v1
acceptance=true
acceptance_scope=current_structural_and_metamorphic_not_legacy_numerical
...
printf 'FISH_GATE_D_CURRENT_V1=PASS\n'
