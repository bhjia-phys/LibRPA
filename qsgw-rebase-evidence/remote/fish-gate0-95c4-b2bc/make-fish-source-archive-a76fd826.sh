...
run_root=/home/bhj/ai-runs/librpa-qsgw-source-archive-a76fd826-20260716T0848
...
cp "$0" "$run_root/make-fish-source-archive-a76fd826.sh"
{
...
(
  ...
  sha256sum \
    ...
    make-fish-source-archive-a76fd826.sh \
