...
run_root=$base/librpa-qsgw-gate-a1-candidate-symmetry-nomix-miniter2-capability-20260720-v3
...
candidate_build=/tmp/librpa-qsgw-symmetry-preflight-b7273e13-20260720-v3/build
candidate_exe=$candidate_build/chi0_main.exe
candidate=$run_root/candidate
build_evidence=$base/librpa-qsgw-gate-a0-candidate-symmetry-preflight-build-20260720-v3
...
expected_candidate_exe_sha=0a2111174925f6d6d627d933e311149a00fbfe0ed884c5766bf826503936b5cd
expected_modified_driver_sha=7292378d46af4fe924d79d57258307b3b6615d7563c82c5d49de86ffa6670cee
...
test -e "$build_evidence/COMPLETE"
...
grep -Fqx "modified_driver_sha256=$expected_modified_driver_sha" \
  "$build_evidence/PROVENANCE.txt"
...
candidate_modified_driver_sha256=$expected_modified_driver_sha
candidate_build_evidence=$build_evidence
crystal_symmetry=on_ibz_8_to_full_bz_64
abacus_reader_symmetry=exx_and_gw_enabled
...
gate=gate_a1_candidate_symmetry_nomix_miniter2_capability_v3
...
echo GATE_A1_CANDIDATE_SYMMETRY_NOMIX_MINITER2_CAPABILITY_V3=PASS
