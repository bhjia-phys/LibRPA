...
run_root=/home/bhj/ai-runs/librpa-qsgw-gate-a0-builds-20260720-v3
legacy_source=/tmp/librpa-qsgw-gate-a0-legacy-e08f4a13-20260720-v3
...
git -C "$legacy_source" diff --exit-code -- . ':!thirdparty/LibRI'
