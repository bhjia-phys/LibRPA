...
run_root=$base/librpa-qsgw-gate-a1-mixing-frontier-audit-20260720-v2
...
staging=/tmp/librpa-qsgw-gate-a1-mixing-frontier-audit-20260720-v2
audit_name=audit_gate_a1_mixing_frontier_v2.py
test_name=test_audit_gate_a1_mixing_frontier_v2.py
...
expected_audit_sha=11c1202d76f54a9b9325cd1fd86d343d34dc3c8c785d9969a48a9ce63504099b
expected_test_sha=68cebd0698b60716b65a75bdd3eca921d353693aa34851b30dd8a33fb10c8b58
...
gate=gate_a1_mixing_frontier_audit_v2
...
assert report["schema"] == "librpa-qsgw-mixing-frontier-audit-v2"
...
echo GATE_A1_MIXING_FRONTIER_AUDIT_V2=PASS
