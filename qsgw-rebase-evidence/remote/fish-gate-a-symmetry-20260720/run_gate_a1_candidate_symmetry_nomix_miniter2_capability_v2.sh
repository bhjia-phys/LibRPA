...
run_root=$base/librpa-qsgw-gate-a1-candidate-symmetry-nomix-miniter2-capability-20260720-v2
...
gate=gate_a1_candidate_symmetry_nomix_miniter2_capability_v2
...
echo GATE_A1_CANDIDATE_SYMMETRY_NOMIX_MINITER2_CAPABILITY_V2=PASS
