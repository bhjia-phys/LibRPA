...
run_root=/home/bhj/ai-runs/librpa-qsgw-gate-a0-legacy-847reader-build-20260720-v4
legacy_source=/tmp/librpa-qsgw-gate-a0-legacy-e08f4a13-847reader-20260720-v4
...
expected_legacy_reader_patch_sha=15ef9472296c6aef3d59c8ee132bf2a27e8f00d562a27c0b6de6f887c2033686
...
git -C "$legacy_source" diff -- driver/read_data.cpp \
...
legacy_reader_patch_scope=driver/read_data.cpp_only_oracle_build
...
echo GATE_A0_LEGACY_847READER_BUILD=PASS
