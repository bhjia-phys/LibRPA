...
run_root=/home/bhj/ai-runs/librpa-qsgw-gate-a-current-${RUN_TAG}
...
dataset_input_dir=$input_overlay/
...
adapter_sha=8db2cbb91f764352239549bfde30a4ac64c28dccc522cb2085edcdd6c9b567e4
adapter_test_sha=289063d92db87c70b74d983028e568b70f15dc9c1cc158417fe8f036b46f1290
...
cp "$0" "$run_root/run_fish_gate_a_current_v2.sh"
...
pair=legacy_compatibility_harness_vs_candidate_per_mixing_mode
changed_factor=implementation_with_identical_overlay_input_and_mode
mode_a=direct_beta_1_vs_none_miniter2
mode_b=linear_beta_0.2_vs_linear_beta_0.2_miniter5
...
input_contract_sha256=$overlay_contract_sha
stru_out_sha256=$overlay_stru_sha
...
EOF
  ...
  PYTHONPATH="$run_root/tools" "$python" -B \
    ...
    "$input_overlay/band_out" "$mode_root/current-fixed-basis.json" \
    --iterations "0:$target_iter" --channel 0 \
  ...
  PYTHONPATH="$run_root/tools" "$python" -B \
    ...
    "$candidate_run/qsgw_matrices.dat" \
    "$candidate_run/qsgw_iterations.dat" \
    "$input_overlay/band_out" "$mode_root/current-initial-state.json" \
...
input_overlay=$input_overlay
overlay_contract_sha256=$overlay_contract_sha
overlay_stru_out_sha256=$overlay_stru_sha
overlay_vxc_out_sha256=$vxc_sha
...
printf 'FISH_GATE_A_CURRENT_V2=PASS\n'
