...
cp "$0" "$run_root/run_fish_gate_a_current_v3.sh"
...
changed_factor=implementation_with_reader_compatible_metadata_views
...
printf 'FISH_GATE_A_CURRENT_V3=PASS\n'
